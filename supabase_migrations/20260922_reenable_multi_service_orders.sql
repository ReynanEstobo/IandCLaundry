-- Run after 20260920_rollback_multi_service_orders.sql when multi-service
-- orders are being enabled again. This is intentionally the full 20260919
-- setup because the rollback removed its tables, columns, functions, and
-- triggers while preserving orders and other business records.
